 ...
 * Plugin Name
 *
 * @package           PERPETUAL_CALENDAR
 * @author            InstallActivateGo.com
 * @copyright         Copyright (C) 2013-2024, InstallActivateGo.com
 *
 * @wordpress-plugin
 * Plugin Name:       Perpetual Calendar Infinite Day of Week Calculator
...
if ( ( FALSE === ( $internal_settings = get_option( 'jr_pc_internal_settings', array() ) ) ) 
